...
class AgentRunner:
    ...
    async def _rewind_session_items(
        ...
        for item in items:
            serialized = AgentRunner._serialize_item_for_matching(
        ...
        while remaining:
            try:
                ...
                popped_serialized = AgentRunner._serialize_item_for_matching(
        ...
        if remaining:
            ...
            await AgentRunner._wait_for_session_cleanup(
                session,
